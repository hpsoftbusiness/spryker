...
class ProductAffiliateServiceTest extends Unit
{
     ...
     * @return void
     */
    public function testExceptionThrownIfLinkFormatterNotFound(): void
    {
        self::expectException(ProductAffiliateTrackingLinkGeneratorException::class);

        $this->sut->generateProductAffiliateTrackingUrl('link', 'random', $this->customerTransfer);
    }

    /**
     * @return void
     */
    public function testExceptionThrownIfAdvertiserIdMissing(): void
    {
        self::expectException(ProductAffiliateTrackingLinkGeneratorException::class);

        $this->sut->generateProductAffiliateTrackingUrl(
            'https://www.awin1.com/pclick.php?p=27134543463&a=333979',
            'AWIN',
            $this->customerTransfer
        );
    }
