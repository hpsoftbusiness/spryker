 ...
 * @group ProductAbstractCustomerNotGroupFacetPageMapExpanderPluginTest
 * Add your own group annotations below this line
 */
class ProductAbstractCustomerNotGroupFacetPageMapExpanderPluginTest extends AbstractProductAbstractMapExpanderPluginTest
{
    protected const KEY_PRODUCT_LIST = 'product_list_map';
    protected const KEY_WHITE_LIST = 'whitelists';
    /**
     * @var \Pyz\Zed\ProductPageSearch\Communication\Plugin\ProductAbstractMapExpander\ProductAbstractCustomerNotGroupFacetPageMapExpanderPlugin
     */
    private $sut;
    ...
    {
        $this->sut = new ProductAbstractCustomerNotGroupFacetPageMapExpanderPlugin();
    }
    ...
    public function testSellableCountriesCollectedForFacet(array $productTestedData, array $expectedFacetValue): void
    {
        ...
        self::assertEquals(CatalogConfig::PRODUCT_ABSTRACT_NOT_CUSTOMER_GROUP_FACET_NAME, $facet->getName());
