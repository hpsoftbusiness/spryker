...
class BusinessDataHelper
{
    ...
    public const PAYMENT_DATA_RESPONSE_DEFAULT_SEED = [
        PaymentDataResponseTransfer::CURRENCY_ID => 'EUR',
        PaymentDataResponseTransfer::AMOUNT => 3000,
        PaymentDataResponseTransfer::PAYMENT_ID => '795bc398-be91-41dc-87b9-d95b2cc429a1',
        PaymentDataResponseTransfer::STATUS => PyzPaymentMyWorldTableMap::COL_STATUS_CHARGED,
        PaymentDataResponseTransfer::REFERENCE => 'MyWorld_Order_1621902434_999',
    ];

    public const E_VOUCHER_PAYMENT_OPTION_ID = 1;
    public const E_VOUCHER_ON_BEHALF_OF_MARKETER_PAYMENT_OPTION_ID = 2;
    public const CASHBACK_PAYMENT_OPTION_ID = 6;
    public const BENEFIT_VOUCHER_PAYMENT_OPTION_ID = 10;
    ...
    /**
     * @param array $refundOverride
     *
     * @return \Generated\Shared\Transfer\RefundTransfer
     */
    public function buildRefundTransfer(array $refundOverride = []): RefundTransfer
    {
        return (new RefundBuilder($refundOverride))->build();
    }
}
