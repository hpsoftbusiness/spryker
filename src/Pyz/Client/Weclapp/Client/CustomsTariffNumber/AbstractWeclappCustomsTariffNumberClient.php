...
abstract class AbstractWeclappCustomsTariffNumberClient extends AbstractWeclappClient
{
    /**
     * @var \Pyz\Client\Weclapp\Client\CustomsTariffNumber\CustomsTariffNumberMapperInterface
     */
    protected $customsTariffNumberMapper;
     ...
     * @param \Pyz\Client\Weclapp\Client\CustomsTariffNumber\CustomsTariffNumberMapperInterface $customsTariffNumberMapper
     */
    public function __construct(
        ...
        CustomsTariffNumberMapperInterface $customsTariffNumberMapper
    ) {
        parent::__construct($httpClient, $weclappConfig, $apiLogClient, $errorLogger);
        $this->customsTariffNumberMapper = $customsTariffNumberMapper;
    }
}
