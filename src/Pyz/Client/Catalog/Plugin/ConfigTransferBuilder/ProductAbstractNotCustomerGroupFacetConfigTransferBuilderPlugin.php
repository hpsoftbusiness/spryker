...
class ProductAbstractNotCustomerGroupFacetConfigTransferBuilderPlugin extends AbstractPlugin implements FacetConfigTransferBuilderPluginInterface
{
    /**
    ...
    public function build(): FacetConfigTransfer
    {
        return (new FacetConfigTransfer())
            ->setName(CatalogConfig::PRODUCT_ABSTRACT_NOT_CUSTOMER_GROUP_FACET_NAME)
            ->setParameterName(CatalogConfig::PRODUCT_ABSTRACT_NOT_CUSTOMER_GROUP_FACET_NAME)
