...
class ProductAbstractSellableFacetConfigTransferBuilderPlugin extends AbstractPlugin implements FacetConfigTransferBuilderPluginInterface
{
    /**
    ...
    public function build(): FacetConfigTransfer
    {
        return (new FacetConfigTransfer())
            ->setName(CatalogConfig::PRODUCT_ABSTRACT_SELLABLE_FACET_NAME)
