...
class ProductAbstractNotSellableFacetConfigTransferBuilderPlugin extends AbstractPlugin implements FacetConfigTransferBuilderPluginInterface
{
    /**
    ...
    public function build(): FacetConfigTransfer
    {
        return (new FacetConfigTransfer())
            ->setName(CatalogConfig::PRODUCT_ABSTRACT_NOT_SELLABLE_FACET_NAME)
            ->setParameterName(CatalogConfig::PRODUCT_ABSTRACT_NOT_SELLABLE_FACET_NAME)
