 ...
 */
class BenefitVoucherCollectionForm extends AbstractType
{
    public const FORM_FIELD_NAME = 'benefitItems';
    ...
    protected function addCollectionsForUseBenefitVouchers(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add(static::FORM_FIELD_NAME, CollectionType::class, [
            'entry_type' => BenefitVoucherItemForm::class,
