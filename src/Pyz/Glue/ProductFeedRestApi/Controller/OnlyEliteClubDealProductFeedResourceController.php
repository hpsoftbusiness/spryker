 ...
 */
class OnlyEliteClubDealProductFeedResourceController extends AbstractController
{
    /**
     * @Glue({
     *     "getCollection": {
     *          "summary": [
     *              "Only Elite Club Deal product feed search"
     *          ],
     *          "parameters": [
     *              {
    ...
    public function getAction(RestRequestInterface $restRequest): RestResponseInterface
    {
        return $this->getFactory()
            ...
            ->findOnlyEliteClubDealProducts($restRequest);
    }
}
