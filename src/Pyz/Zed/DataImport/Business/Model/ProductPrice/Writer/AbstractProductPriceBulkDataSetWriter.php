...
abstract class AbstractProductPriceBulkDataSetWriter implements DataSetWriterInterface
{
    ...
    public function write(DataSetInterface $dataSet): void
    {
        ...
        if (count(static::$priceProductAbstractCollection) >= static::BULK_SIZE ||
    ...
    {
        foreach ($dataSet[ProductPriceHydratorStep::PRICE_PRODUCT_TRANSFER] as $priceProductEntityTransfer) {
            $productPriceItem = $priceProductEntityTransfer->modifiedToArray();
            if (array_key_exists(ProductPriceHydratorStep::KEY_SPY_PRODUCT_ABSTRACT, $productPriceItem)) {
                $keyToCheck = $productPriceItem[ProductPriceHydratorStep::KEY_SPY_PRODUCT_ABSTRACT]['sku'] . '_' . $productPriceItem[self::COLUMN_PRICE_TYPE]['name'];
                if (!isset(static::$priceProductAbstractCollection[$keyToCheck])) {
            ...
            if (array_key_exists(ProductPriceHydratorStep::KEY_PRODUCT, $productPriceItem)) {
