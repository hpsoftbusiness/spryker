    ...
    public function createAbstractProductSQL(): string
    {
        return '
                ...
                records AS (
                    ...
                    FROM (
                       SELECT DISTINCT
                            ...
                            NULLIF(SUBSTRING_INDEX(SUBSTRING_INDEX(temp.isAffiliates, \',\', n.digit + 1), \',\', -1), \'\') as isAffiliate,
                       ...
                       INNER JOIN n
                          ON LENGTH(REPLACE(abstractSkues, \',\', \'\')) <= LENGTH(abstractSkues) - n.digit
                            ...
                            AND LENGTH(REPLACE(isAffiliates, \',\', \'\')) <= LENGTH(isAffiliates) - n.digit
            ...
            ON DUPLICATE KEY UPDATE sku = records.abstract_sku,
              ...
              is_affiliate = records.isAffiliate,
