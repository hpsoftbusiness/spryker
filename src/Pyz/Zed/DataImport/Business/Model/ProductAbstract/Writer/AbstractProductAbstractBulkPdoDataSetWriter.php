...
abstract class AbstractProductAbstractBulkPdoDataSetWriter implements DataSetWriterInterface
{
     ...
     * @var array
     */
    protected static $productUrlListCollection = [];
    ...
    {
        foreach ($dataSet[ProductAbstractHydratorStep::DATA_PRODUCT_ABSTRACT_LOCALIZED_TRANSFER] as $idLocale => $productAbstractLocalizedTransfer) {
    ...
    protected function prepareProductCategoryCollection(DataSetInterface $dataSet): void
    {
        foreach ($dataSet[ProductAbstractHydratorStep::DATA_PRODUCT_CATEGORY_TRANSFER] as $productCategoryTransfer) {
            ...
            $productCategoryArray[CombinedProductAbstractBulkPdoMariaDbDataSetWriter::COLUMN_ABSTRACT_SKU] = $productCategoryTransfer[CombinedProductAbstractBulkPdoMariaDbDataSetWriter::COLUMN_ABSTRACT_SKU];
            static::$productCategoryCollection[$productCategoryTransfer[CombinedProductAbstractBulkPdoMariaDbDataSetWriter::COLUMN_ABSTRACT_SKU]] = $productCategoryArray;
        }
    }
    ...
    protected function prepareProductUrlCollection(DataSetInterface $dataSet): void
    {
        foreach ($dataSet[ProductAbstractHydratorStep::DATA_PRODUCT_URL_TRANSFER] as $productUrlTransfer) {
            ...
            $productUrlArray[CombinedProductAbstractBulkPdoMariaDbDataSetWriter::COLUMN_ABSTRACT_SKU] = $productUrlTransfer[CombinedProductAbstractBulkPdoMariaDbDataSetWriter::COLUMN_ABSTRACT_SKU];
            static::$productUrlCollection[$productUrlTransfer[CombinedProductAbstractBulkPdoMariaDbDataSetWriter::COLUMN_ABSTRACT_SKU]][$productUrlArray[ProductAbstractHydratorStep::KEY_FK_LOCALE]] = $productUrlArray;
        }
    }
