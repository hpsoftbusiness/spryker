...
//        $this->persistConcreteProductBundleEntities();
    ...
    protected function collectProductConcrete(DataSetInterface $dataSet): void
    {
        if (!$this->isSkuAlreadyCollected($dataSet)) {
            ...
            $productConcreteTransfer[ProductConcreteHydratorStep::COLUMN_ABSTRACT_SKU] = $dataSet[static::COLUMN_ABSTRACT_SKU];
            static::$productConcreteCollection[uniqid()] = $productConcreteTransfer;
        }
    }
    ...
    protected function collectProductConcreteLocalizedAttributes(DataSetInterface $dataSet): void
    {
        foreach ($dataSet[ProductConcreteHydratorStep::DATA_PRODUCT_CONCRETE_LOCALIZED_TRANSFER] as $productConcreteLocalizedTransfer) {
            ...
            $productSearchArray[ProductConcreteHydratorStep::KEY_SKU] = $concreteSku;
            ...
            static::$productLocalizedAttributesCollection[$concreteSku][$idLocale] = $localizedAttributeArray;
            static::$productSearchCollection[$concreteSku][$idLocale] = $productSearchArray;
        }
    }
