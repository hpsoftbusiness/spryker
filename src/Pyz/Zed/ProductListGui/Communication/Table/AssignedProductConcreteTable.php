...
use Spryker\Zed\ProductListGui\Communication\Table\AssignedProductConcreteTable as SprykerAssignedProductConcreteTable;

class AssignedProductConcreteTable extends SprykerAssignedProductConcreteTable
{
    /**
