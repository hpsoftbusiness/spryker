 ...
 */
class GrandTotalWithDealsCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateQuoteGrandTotalWithDeals($calculableObjectTransfer);
    }
}
