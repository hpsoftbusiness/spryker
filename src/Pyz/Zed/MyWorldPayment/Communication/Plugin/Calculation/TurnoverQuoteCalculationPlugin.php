 ...
 */
class TurnoverQuoteCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateQuoteTurnover($calculableObjectTransfer);
    }
}
