 ...
 */
class EVoucherPaymentQuoteCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateEVoucherPaymentForQuote($calculableObjectTransfer);
    }
}
