 ...
 */
class EVoucherMarketerPaymentQuoteCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateEVoucherMarketerPaymentForQuote($calculableObjectTransfer);
    }
}
