 ...
 */
class ShoppingPointsOrderCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateOrderShoppingPoints($calculableObjectTransfer);
    }
}
