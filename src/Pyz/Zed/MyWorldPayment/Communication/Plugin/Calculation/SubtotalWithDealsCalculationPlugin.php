 ...
 */
class SubtotalWithDealsCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateQuoteSubtotalWithDeals($calculableObjectTransfer);
    }
}
