 ...
 */
class SegmentNumberOrderCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateOrderSegmentNumber($calculableObjectTransfer);
    }
}
