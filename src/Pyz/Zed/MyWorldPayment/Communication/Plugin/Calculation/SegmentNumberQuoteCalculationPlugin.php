 ...
 */
class SegmentNumberQuoteCalculationPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->recalculateQuoteSegmentNumber($calculableObjectTransfer);
    }
}
