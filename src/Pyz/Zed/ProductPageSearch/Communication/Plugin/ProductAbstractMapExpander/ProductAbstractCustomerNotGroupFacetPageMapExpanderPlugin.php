...
class ProductAbstractCustomerNotGroupFacetPageMapExpanderPlugin extends AbstractProductAbstractCustomerGroupFacetPageMapExpanderPlugin
{
    /**
    ...
    protected function collectCustomerGroups(array $productLists): array
    {
        ...
        foreach ($productListsTransfer as $productListTransfer) {
            if (in_array($productListTransfer->getIdProductList(), $productLists)) {
                continue;
            }
    ...
    {
        return $this->getConfig()->getProductAbstractNotCustomerGroupFacetName();
    }
}
