 ...
 */
class ProductAbstractNotSellableFacetPageMapExpanderPlugin extends AbstractPlugin implements ProductAbstractMapExpanderPluginInterface
{
    ...
    public function expandProductMap(
        ...
        $notSellableCountries = $this->collectSellableCountries($productAttributes);
        $pageMapBuilder->addStringFacet($pageMapTransfer, $this->getName(), $notSellableCountries);
    ...
    {
        return $this->getConfig()->getProductAbstractNotSellableFacetName();
    }
