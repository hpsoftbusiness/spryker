...
class ProductAbstractSearchDataMapper extends SprykerProductAbstractSearchDataMapper
{
    ...
    protected function buildPageMap(array $data, LocaleTransfer $localeTransfer): PageMapTransfer
    {
        ...
        $this->pageMapBuilder->addSearchResultData($pageMapTransfer, 'cashback_amount', $data['attributes']['cashback_amount'] ?? null);
        $this->pageMapBuilder->addSearchResultData($pageMapTransfer, 'shopping_points', $data['attributes']['shopping_points'] ?? null);
