 ...
 */
class ValidateRefundCommand extends AbstractPlugin implements CommandByOrderInterface
{
    /**
    ...
    {
        $this->getFacade()->validateRefund($orderItems, $orderEntity->getIdSalesOrder());
