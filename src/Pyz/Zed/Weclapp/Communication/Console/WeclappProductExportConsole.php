 ...
 */
class WeclappProductExportConsole extends Console
{
    public const COMMAND_NAME = 'weclapp:product:export';
    public const DESCRIPTION = 'Export products to Weclapp';
    ...
    {
        $this->getFacade()->exportAllProducts();
