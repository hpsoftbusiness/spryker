 ...
 */
class WeclappTaxRateExportConsole extends Console
{
    public const COMMAND_NAME = 'weclapp:tax-rate:export';
    public const DESCRIPTION = 'Export tax rates to Weclapp';
    ...
    {
        $this->getFacade()->exportAllTaxRates();
