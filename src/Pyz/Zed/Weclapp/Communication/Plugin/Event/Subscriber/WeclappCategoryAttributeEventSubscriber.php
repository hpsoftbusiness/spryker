...
use Pyz\Zed\Weclapp\Communication\Plugin\Event\Listener\WeclappCategoryAttributeExportBulkListener;
 ...
 */
class WeclappCategoryAttributeEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    /**
     * @api
     *
    ...
    protected function addUpdateListener(EventCollectionInterface $eventCollection): void
    {
        $eventCollection->addListenerQueued(
            CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_UPDATE,
            new WeclappCategoryAttributeExportBulkListener(),
            0,
            null,
    ...
    {
        $eventCollection->addListenerQueued(
            CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_CREATE,
            new WeclappCategoryAttributeExportBulkListener(),
            0,
            null,
            $this->getConfig()->getEventQueueName()
