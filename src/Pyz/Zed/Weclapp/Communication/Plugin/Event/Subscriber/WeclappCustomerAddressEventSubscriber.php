...
use Pyz\Zed\Customer\Dependency\CustomerAddressEvents;
use Pyz\Zed\Weclapp\Communication\Plugin\Event\Listener\WeclappCustomerAddressExportBulkListener;
 ...
 */
class WeclappCustomerAddressEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    /**
     * @api
     *
    ...
    protected function addUpdateListener(EventCollectionInterface $eventCollection): void
    {
        $eventCollection->addListenerQueued(
            CustomerAddressEvents::ENTITY_SPY_CUSTOMER_ADDRESS_UPDATE,
            new WeclappCustomerAddressExportBulkListener(),
            0,
            null,
    ...
    {
        $eventCollection->addListenerQueued(
            CustomerAddressEvents::ENTITY_SPY_CUSTOMER_ADDRESS_CREATE,
            new WeclappCustomerAddressExportBulkListener(),
            0,
            null,
            $this->getConfig()->getEventQueueName()
