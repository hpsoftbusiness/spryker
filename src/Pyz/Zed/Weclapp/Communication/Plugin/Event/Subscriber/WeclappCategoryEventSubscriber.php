...
use Pyz\Zed\Weclapp\Communication\Plugin\Event\Listener\WeclappCategoryExportBulkListener;
 ...
 */
class WeclappCategoryEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    /**
     * @api
     *
    ...
    protected function addUpdateListener(EventCollectionInterface $eventCollection): void
    {
        $eventCollection->addListenerQueued(
            CategoryEvents::ENTITY_SPY_CATEGORY_UPDATE,
            new WeclappCategoryExportBulkListener(),
            0,
            null,
    ...
    {
        $eventCollection->addListenerQueued(
            CategoryEvents::ENTITY_SPY_CATEGORY_CREATE,
            new WeclappCategoryExportBulkListener(),
            0,
            null,
            $this->getConfig()->getEventQueueName()
