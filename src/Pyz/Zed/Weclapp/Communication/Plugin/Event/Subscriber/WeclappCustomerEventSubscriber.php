...
use Pyz\Zed\Customer\Dependency\CustomerEvents;
use Pyz\Zed\Weclapp\Communication\Plugin\Event\Listener\WeclappCustomerExportBulkListener;
 ...
 */
class WeclappCustomerEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    /**
     * @api
     *
    ...
    protected function addUpdateListener(EventCollectionInterface $eventCollection): void
    {
        $eventCollection->addListenerQueued(
            CustomerEvents::ENTITY_SPY_CUSTOMER_UPDATE,
            new WeclappCustomerExportBulkListener(),
            0,
            null,
