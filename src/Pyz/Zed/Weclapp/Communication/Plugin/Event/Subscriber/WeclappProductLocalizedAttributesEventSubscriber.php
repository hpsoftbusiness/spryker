...
use Pyz\Zed\Weclapp\Communication\Plugin\Event\Listener\WeclappProductLocalizedAttributesExportBulkListener;
 ...
 */
class WeclappProductLocalizedAttributesEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    /**
     * @api
     *
    ...
    protected function addUpdateListener(EventCollectionInterface $eventCollection): void
    {
        $eventCollection->addListenerQueued(
            ...
            new WeclappProductLocalizedAttributesExportBulkListener(),
            0,
            null,
