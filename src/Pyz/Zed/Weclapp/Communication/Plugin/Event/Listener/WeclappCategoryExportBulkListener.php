 ...
 */
class WeclappCategoryExportBulkListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
     * @api
     *
    ...
    {
        $categoriesIds = $this->getFactory()->getEventBehaviorFacade()->getEventTransferIds($transfers);
