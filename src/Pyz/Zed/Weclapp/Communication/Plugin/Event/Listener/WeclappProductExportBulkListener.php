 ...
 */
class WeclappProductExportBulkListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
     * @api
     *
    ...
    {
        $productsIds = $this->getFactory()->getEventBehaviorFacade()->getEventTransferIds($transfers);
