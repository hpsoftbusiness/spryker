 ...
 */
class WeclappCategoryAttributeExportBulkListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
     * @api
     *
    ...
    public function handleBulk(array $transfers, $eventName): void
    {
        $categoriesIds = $this->getFactory()
            ...
            ->getEventTransferForeignKeys($transfers, SpyCategoryAttributeTableMap::COL_FK_CATEGORY);
