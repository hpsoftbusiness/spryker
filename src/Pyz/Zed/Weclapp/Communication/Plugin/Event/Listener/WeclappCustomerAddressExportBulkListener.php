 ...
 */
class WeclappCustomerAddressExportBulkListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
     * @api
     *
    ...
    {
        $customersIds = $this->getFactory()
            ->getEventBehaviorFacade()
            ->getEventTransferForeignKeys($transfers, SpyCustomerAddressTableMap::COL_FK_CUSTOMER);
        $this->getFacade()->exportCustomers($customersIds, false);
    }
}
