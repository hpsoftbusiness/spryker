 ...
 */
class WeclappCustomerExportBulkListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
     * @api
     *
    ...
    {
        $customersIds = $this->getFactory()->getEventBehaviorFacade()->getEventTransferIds($transfers);
