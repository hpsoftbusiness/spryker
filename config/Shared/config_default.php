...
$config[VaultConstants::ENCRYPTION_KEY] = getenv('SPRYKER_VAULT_ENCRYPTION_KEY') ?: null;
...
// >>> SECURITY_BLOCKER
$config[SecurityBlockerConstants::SECURITY_BLOCKER_REDIS_PERSISTENT_CONNECTION] = $config[StorageRedisConstants::STORAGE_REDIS_PERSISTENT_CONNECTION];
$config[SecurityBlockerConstants::SECURITY_BLOCKER_REDIS_PROTOCOL] = $config[StorageRedisConstants::STORAGE_REDIS_PROTOCOL];
$config[SecurityBlockerConstants::SECURITY_BLOCKER_REDIS_HOST] = $config[StorageRedisConstants::STORAGE_REDIS_HOST];
$config[SecurityBlockerConstants::SECURITY_BLOCKER_REDIS_PORT] = $config[StorageRedisConstants::STORAGE_REDIS_PORT];
$config[SecurityBlockerConstants::SECURITY_BLOCKER_REDIS_PASSWORD] = $config[StorageRedisConstants::STORAGE_REDIS_PASSWORD];
$config[SecurityBlockerConstants::SECURITY_BLOCKER_REDIS_DATABASE] = $config[StorageRedisConstants::STORAGE_REDIS_DATABASE];
...
$config[LocaleConstants::LOCALS_PER_STORES] = [
    'AT' => ['de' => 'de_AT', 'en' => 'en_US'],
    'DE' => ['de' => 'de_DE', 'en' => 'en_US'],
    'IT' => ['it' => 'it_IT', 'en' => 'en_US'],
    'PT' => ['pt' => 'pt_PT', 'en' => 'en_US'],
    'PL' => ['pl' => 'pl_PL', 'en' => 'en_US'],
    'RO' => ['ro' => 'ro_RO', 'en' => 'en_US'],
    'SK' => ['sk' => 'sk_SK', 'en' => 'en_US'],
    'SI' => ['si' => 'sl_SI', 'en' => 'en_US'],
    'BE' => ['en' => 'en_US', 'nl' => 'nl_BE', 'fr' => 'fr_BE'],
    'BG' => ['bg' => 'bg_BG', 'en' => 'en_US'],
    'HR' => ['hr' => 'hr_HR', 'en' => 'en_US'],
    'CZ' => ['cs' => 'cs_CZ', 'en' => 'en_US'],
    'DK' => ['da' => 'da_DK', 'en' => 'en_US'],
    'ES' => ['es' => 'es_ES', 'en' => 'en_US'],
    'EE' => ['et' => 'et_EE', 'en' => 'en_US', 'ru' => 'ru_RU'],
    'FI' => ['fi' => 'fi_FI', 'en' => 'en_US'],
    'FR' => ['fr' => 'fr_FR', 'en' => 'en_US'],
    'GR' => ['el' => 'el_GR', 'en' => 'en_US'],
    'HU' => ['hu' => 'hu_HU', 'en' => 'en_US'],
    'IE' => ['en' => 'en_IE'],
    'LV' => ['lv' => 'lv_LV', 'en' => 'en_US', 'ru' => 'ru_RU'],
    'LT' => ['lt' => 'lt_LT', 'en' => 'en_US', 'ru' => 'ru_RU'],
    'NL' => ['nl' => 'nl_NL', 'en' => 'en_US'],
    'NO' => ['nb' => 'nb_NO', 'en' => 'en_US'],
    'SE' => ['sv' => 'sv_SE', 'en' => 'en_US'],
    'CH' => ['de' => 'de_CH', 'en' => 'en_US', 'it' => 'it_CH', 'fr' => 'fr_CH'],
    'GB' => ['en' => 'en_GB'],
    'US' => ['en' => 'en_US'],
    'MK' => ['mk' => 'mk_MK', 'en' => 'en_US'],
    'AL' => ['sq' => 'sq_AL', 'en' => 'en_US'],
    'XK' => ['en' => 'en_US', 'sr' => 'sr_RS', 'sq' => 'sq_AL'],
    'MD' => ['ro' => 'ro_MD', 'en' => 'en_US'],
    'BA' => ['bs' => 'bs_BA', 'en' => 'en_US'],
    'RS' => ['sr' => 'sr_RS', 'en' => 'en_US'],
    'ME' => ['sr' => 'sr_ME', 'en' => 'en_US'],
    'CA' => ['fr' => 'fr_CA', 'en' => 'en_US'],
    'BR' => ['pt' => 'pt_BR', 'en' => 'en_US'],
    'CO' => ['es' => 'es_CO', 'en' => 'en_US'],
    'MX' => ['es' => 'es_MX', 'en' => 'en_US'],
    'MY' => ['en' => 'en_US'],
    'HK' => ['en' => 'en_US'],
    'AU' => ['en' => 'en_US'],
    'NZ' => ['en' => 'en_US'],
